...
export default function SeventhSection() {
  return (
    <section className="w-full  font-d2 text-[1.4rem] text-text-primary font-[400]">
      <div className="w-full font-d2 font-[700]">From Likelion Sogang</div>
      <div className="flex gap-[2.4rem] border-t-text-primary border-t-[1px] my-[1.6rem]">
