              ...
              {trackList.map((track, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex justify-end w-full gap-[1.2rem] max-[1200px]:max-w-[28.225rem] max-2xl:max-w-[23.225rem] max-[860px]:max-w-[16.725rem] max-md:max-w-full max-md:justify-between max-md:pt-[1.6rem]">
