...
export default function PeoplePage() {
  ...
  return (
    <main className="blueBackground wrapper w-full h-full flex flex-col  items-center  pt-[5.752rem] max-2xl:pt-[18.2rem] bg-gradient-to-r from-surface-tertiary from-0% via-[#D3E8FF] via-27% to-text-primary to-90%">
      <FirstSection
