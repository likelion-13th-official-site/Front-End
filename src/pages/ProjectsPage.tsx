...
export default function ProjectsPage() {
  ...
  return (
    <main
      id="projects-main"
      className="flex flex-col items-center w-[screen] px-[1.6rem] md:px-[3.2rem] pt-[14.3rem] md:pt-[26.6rem] 2xl:pt-[14.3rem] pb-[9.6rem] font-d2 text-text-primary bg-surface-primary"
    >
      <div
        id="tab-wrapper"
