        ...
        <div className="rightSection w-full pl-[1.2rem]">
          <div>
            <div className="credits leading-[1.4] text-[1.4rem]">
              ...
              <div className="">
                {makers.map((maker, idx1) => (
                  <div
                    key={idx1}
                    className="border-b-text-invert border-b-[1px] flex py-[0.4rem]"
                  >
                    <div className="w-[50%]">{maker.part}</div>
                    <div className="w-[50%] flex flex-col gap-[0.4rem]">
                      {maker.names.map((name, idx2) => (
