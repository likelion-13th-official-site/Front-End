...
export default function AboutPage() {
  ...
  return (
    <main className="main relative w-full flex items-center justify-center max-2xl:block ">
      <div
        style={{ height: screenSize < 1100 ? height : '' }}
        className="w-[50%] text-[20rem] fixed max-2xl:sticky top-0 left-0 h-full max-2xl:w-[100%] max-2xl:left-auto bg-gradient-to-r from-surface-tertiary from-0% via-surface-secondary via-27.5% to-text-primary to-90% "
      >
        sdfsdf
      </div>
